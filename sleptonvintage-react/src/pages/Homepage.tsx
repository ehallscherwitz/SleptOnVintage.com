  ...
  return (
    <div className="homepage">
      ...
      <div className="homepage-all-items-wrap">
        <Link to="/giveaway" className="homepage-all-items-btn homepage-giveaway-btn">
          GIVEAWAY{giveawayTimeLeft ? ` · ${giveawayTimeLeft}` : ''}{' '}
          <i className="fa-solid fa-arrow-right" aria-hidden="true" />
        </Link>
      </div>
      <div className="homepage-all-items-wrap homepage-all-items-wrap--secondary">
